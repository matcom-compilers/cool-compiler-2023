...
El paso de _COOL_ a _Mips_ es demasiado complejo, por ello se dividió el proceso de generación de código en dos etapas:
...
tipo declarado para poder acceder a ellos y devolverlos en la función type_name.
...
Las expresiones _case_ son de la siguiente forma:
```
case  expr0  of 
 ID_1  :  TYPE_1  =>  expr1 ;
. . .
