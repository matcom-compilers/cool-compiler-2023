...
from semantic_analysis.ast_ import AttrStringLiteral, New, FunctionCall, Void
...
class GenMIPS:
    ...
    def visit_FuncInit(self, node):
        ...
        for decl in node.attrs:  #initialize with default value first
            ...
            self.default = CILCodeGenerator.get_default_value(decl.type)  #use default initialization
